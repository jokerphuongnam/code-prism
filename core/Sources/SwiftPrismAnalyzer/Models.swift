...
struct FlatMapEntry: Encodable {
    ...
    var origin: String?
    /// Token-optimized semantic context generated by local LLM or structural fallback
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case origin
        case semanticContext = "node_context"
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        // Always emit semantic context when present (applies to all node types)
        try c.encodeIfPresent(semanticContext, forKey: .semanticContext)
    }
}
