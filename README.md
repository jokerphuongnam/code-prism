...
Code Prism **language backend** for **kotlin**.

`main` writes SoT only:

```bash
./bin/kotlin-prism --root /path/to/project --out /path/to/project/.codeprism/prism-context.json
```
...
Local path: `~/Documents/Code/code-prism/backends/kotlin-prism`
